...
BOOK_PART_MAX_PAGES = int(os.getenv("BOOK_PART_MAX_PAGES", "10"))
MAX_DOCUMENTS_PER_USER = int(os.getenv("MAX_DOCUMENTS_PER_USER", "10"))
MAX_READINGS_PER_USER_MONTH = int(
    os.getenv("MAX_READINGS_PER_USER_MONTH", "10")
)
...
TTS_ENVIRONMENT = os.getenv("TTS_ENVIRONMENT", "").strip()
...
STREAM_PREFETCH_CHUNKS = int(os.getenv("STREAM_PREFETCH_CHUNKS", "6"))
